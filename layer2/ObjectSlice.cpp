...
// Dead code removed: ObjectSliceAddSlicePoint, ObjectSliceDrawSlice,
// GenerateOutlineOfSlice were unused immediate-mode rendering functions.
...
{
  // Immediate mode rendering removed; picking is handled via shaderCGO path.
}
